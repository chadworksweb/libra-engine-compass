...
Opus spend, no shared-prod-DB writes. Ported from the Rising Compass repo when
the in-process calibrator was deleted (LEC Phase 3); the double-call bug now
lives here, so the guard does too.
"""
